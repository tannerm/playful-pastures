...
module.exports = {
	// Project Identity
	appName: 'cpThemeDefault', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'cp-theme-default', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
