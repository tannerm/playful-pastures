...
.fl-node-<?php echo $id; ?> .fl-post-grid-post .fl-callout {
	<?php if ( ! empty( $settings->bg_color ) ) : ?>
		background-color: <?php echo FLBuilderColor::hex_or_rgb( $settings->bg_color ); ?>;
	<?php endif; ?>	
}
...
.fl-node-<?php echo $id; ?> .fl-post-grid-text {
	padding: <?php echo empty( $settings->post_padding ) ? 0 : intval( $settings->post_padding ); ?>rem;
}
...
<?php if ( $settings->show_image && ! empty( $settings->grid_image_spacing ) ) : ?>
	...
	.fl-node-<?php echo $id; ?> .fl-post-grid-image {
		padding: 0 <?php echo $settings->grid_image_spacing; ?>rem;
	}
	<?php elseif ( 'above-title' == $settings->grid_image_position ) : ?>
	.fl-node-<?php echo $id; ?> .fl-post-grid-image {
		padding: <?php echo $settings->grid_image_spacing; ?>rem <?php echo $settings->grid_image_spacing; ?>rem 0 <?php echo $settings->grid_image_spacing; ?>rem;
	}
	<?php endif; ?>
<?php endif; ?>
