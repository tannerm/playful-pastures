...
defined( 'ABSPATH' ) || die;
/**
 * Class GbBlocl latest_message_block
 */
if ( ! class_exists( 'GbBlock_Latest_Message_Block' ) ) {

	/**
	 * Class GbBlock_Latest_Message_Block
	 */
	class GbBlock_Latest_Message_Block {
		...
		public function load() {
			 ...
			 */
			add_action( 'init', array( $this, 'gbblock_register_latest_message_block' ) );
		 ...
		 * @since 1.0.0
		 */
		public function gbblock_register_latest_message_block() {

			register_block_type(
				'gbblock/latest-message',
				array(
					'attributes'      => array(
						'latestArticle'   => array(
							'type'    => 'boolean',
					...
					'render_callback' => array( $this, 'gbblock_latest_message_block_render_callback' ),
				)
			);
		 ...
		 * @since 1.0.0
		 */
		public function gbblock_latest_message_block_render_callback( $attributes ) {
